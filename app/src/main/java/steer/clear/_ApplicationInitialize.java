...
public class _ApplicationInitialize extends Application {
	
	// Tag used for adding or cancelling requests
    public static final String TAG = _ApplicationInitialize.class.getSimpleName();
 
    // Global singleton 
    private RequestQueue mRequestQueue; 
 
    // Singleton construct
    private static _ApplicationInitialize mInstance; 
    ...
    public static synchronized _ApplicationInitialize getInstance() {
        return mInstance;
    }
